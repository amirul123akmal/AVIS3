...
<body>
    <div class="container mx-auto">
        ...
        <section class="flex w-full mt-10 [&_div]:w-2/6">
            <div class="left mx-auto me-8 h-60 rounded-3xl bg-white flex flex-col items-center justify-center ">
            ...
            <div class="right mx-auto ms-0 rounded-3xl bg-white flex flex-col items-center justify-center">

    ...
    <div class="main-container">
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" placeholder="Enter your income status">
                </div>
                <div>
                    <label class="block text-black font-medium mb-1">IC Num</label>
                    <input type="text" placeholder="Enter your IC number">
                </div>
                <div>
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-black font-medium mb-1">States</label>
                    <select>
            ...
            <div class="mt-4">
                ...
                <textarea rows="3" placeholder="Leave a Message Here"></textarea>
            </div>
        </div>

            ...
            <div class="bg-white rounded-lg shadow-md p-8 max-w-4xl mx-auto">
                ...
                <div id="step1" class="step">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <select id="reportType" class="w-full p-3 bg-gray-100 rounded-md appearance-none focus:ring-2 focus:ring-custom focus:outline-none">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" class="sr-only peer" id="dateRangeToggle">
                    ...
                    <div id="dateRangeFields" class="hidden mb-6">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="startDate" class="w-full p-3 bg-gray-100 rounded-md focus:ring-2 focus:ring-custom focus:outline-none">
                            </div>
                            <div>
                                <label for="endDate" class="block text-gray-700 mb-2">End Date</label>
                                <input type="date" id="endDate" class="w-full p-3 bg-gray-100 rounded-md focus:ring-2 focus:ring-custom focus:outline-none">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-between mt-6">
                    ...
                    <button id="nextStep" class="px-6 py-2 bg-custom text-white rounded-md hover:bg-custom-dark">Next</button>
                </div>
            </div>
        </main>
    </x-admin-sidebar>

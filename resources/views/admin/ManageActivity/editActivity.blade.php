                ...
                <div class="col-span-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-center bg-green-500 rounded-xl w-20">

                                <form action="{{ route('activity.getedit', $activity->activityID) }}">
                                    @csrf
                                    <button type="submit" class="text-white hover:text-red-700" >Edit</button>
                                </form>
                            </div>
                        </div>
                    @endforeach
